...
<label for="<?php echo $wps_page_metakey_subdomain;?>"><?php _e('Make the Page as Subdomain'); ?></label>
</h4>
<p> <?php _e('Tied to'); ?> &nbsp;
...
<p>
    <?php _e('Go to'); ?> &nbsp; <a href="admin.php?page=wps"><?php _e('Subdomains Settings'); ?> &raquo;</a>
</p>
<?php 
}
...
function wps_action_save_postdata( $post_id ) {
  ...
  update_post_meta($post_id, $wps_page_metakey_tie, $metavalue['tietocat']);
  update_post_meta($post_id, $wps_page_metakey_theme, $metavalue['theme']);
}
?>
